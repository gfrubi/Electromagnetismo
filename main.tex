...
\emph{Este apunte ha sido escrito  por A. Saavedra, con una modificación de G. Rubilar, principalmente a partir de las clases de Electromagnetismo I dictadas por el Prof. Joaquín Díaz de Valdés con algunas notas de las clases de Electrodinámica del Prof. Guillermo Rubilar,  ambos en el Departamento de Física de la Universidad de Concepción.}
...
\input{./Cap-Herramientas-Matematicas.tex}
\input{./Cap-Electrostatica.tex}
\input{./Cap-Potencial.tex}
\input{./Cap-Corriente-Electrica.tex}
